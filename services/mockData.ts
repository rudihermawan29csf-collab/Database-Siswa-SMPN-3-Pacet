...
5	ADITYA SAPUTRA	1133	L	0102941935	MOJOKERTO	2010-11-06	3516020611100001	Islam	cembor	6	2	cembor	Cembor	Kec. Gondang	61374	Bersama orang tua	Ojek		085735934006			Tidak		tidak ada	0	Tidak sekolah	Tidak bekerja	Tidak Berpenghasilan		DESI ARTIKA SARI	1977	SMP / sederajat	Wiraswasta	Rp. 1,000,000 - Rp. 1,999,999				Tidak sekolah				Kelas IX B			Tidak		0		3516-LT-09062017-0039																
...
83	YUSRIL ALFAREL NUGRAHA	1213	L	0102747531	MOJOKERTO	2010-09-23	3516032309100001	Islam	DSN. SUMBERGLAGAH	3	6	SUMBERGLAGAH	TANJUNGKENONGO	Kec. Pacet	61374	Bersama orang tua	Jalan kaki		083831538276			Tidak		ABDUL KHOLIK	1990	SMP / sederajat	Wiraswasta	Rp. 1,000,000 - Rp. 1,999,999		DARAWATI	1992	SMP / sederajat	Tidak bekerja	Tidak Berpenghasilan				Tidak sekolah				Kelas IX B			Tidak		0		6768/UM/2010/KAB.MR																
84	ZIDAN RAHMAT ADITYA	1214	L	3113082691	MOJOKERTO	2011-02-24	3516032402110001	Islam	Sumberglagah	1	6	Sumberglagah	Tanjungkenongo	Kec. Pacet	61374	Bersama orang tua	Ojek					Tidak		Abdul Ghofur	1979	SMP / sederajat	Karyawan Swasta	Rp. 500,000 - Rp. 999,999	3516032805790001	EKA RITRI SEPTANI	1983	SMP / sederajat	Tidak bekerja	Tidak Berpenghasilan	3516035006830003							Kelas IX B			Tidak		1		al7060048630																
85	Ninis Daniyah Permatasari	1215	P	0119909345	Mojokerto	2011-01-17	3516035701110003	Islam	Tirto Wening	3	1	Merak	Bendunganjati	Kec. Pacet	61374	Bersama orang tua	Jalan kaki		082131071242			Tidak		Satuwir	1974	SD / sederajat	Wiraswasta	Rp. 1,000,000 - Rp. 1,999,999	3516032602740001	Asyiyah	1977	SD / sederajat	Tidak bekerja	Tidak Berpenghasilan	3516036306770002			Tidak sekolah				Kelas IX B			Tidak		0		7033/DS.T/2011/KAB.MR.																
86	DEFANO HAIKAL RAMADHAN	1217	L	3101245248	Mojokerto	2010-09-01	3516040109100001	Islam	KETAPANRAME	13	6	KETAPANRAME	Ketapanrame	Kec. Trawas	61374	Bersama orang tua	Ojek					Tidak		AHMAD FAUZI	1987	SMA / sederajat	Karyawan Swasta	Rp. 2,000,000 - Rp. 4,999,999	3516042210870001	BRINDA IDA MARINA	1989	SMA / sederajat	Tidak bekerja	Tidak Berpenghasilan	3516046405890001			S1	Pensiunan			Kelas IX A			Tidak		1		11348/DST/2010/KAB.MR																
87	ACHMAD SAIFUL ANWAR	1326	L	0112731155	MOJOKERTO	2011-01-06	3516030601110001	Islam	Tanjung Anom	1	5	Tanjung Anom	Tanjungkenongo	Kec. Pacet	61374	Bersama orang tua	Jalan kaki		081330443837			Tidak		ZAINAL ABIDIN	1971	SMA / sederajat	Wiraswasta	Kurang dari Rp. 500,000	3516031308710002	YATINI	1977	SMP / sederajat	Wiraswasta	Kurang dari Rp. 500,000	3516035308770001			Tidak sekolah				Kelas IX C			Tidak		0		A7060041076																
88	YUSUF ADITYA ALIN PRATAMA	1328	L	0119053352	MOJOKERTO	2011-01-18	3516031801110001	Islam	DSN. KURIPAN	2	6	KURIPAN	KURIPANSARI	Kec. Pacet	61374	Bersama orang tua	Ojek		08887081914			Tidak		ALI MUNIR	1978	SMP / sederajat	Karyawan Swasta	Rp. 1,000,000 - Rp. 1,999,999		INDAHYATI	1986	SMP / sederajat	Karyawan Swasta	Rp. 500,000 - Rp. 999,999				Tidak sekolah				Kelas IX B			Tidak		0		617/UM/2011/KAB.MR																
89	Samsul Nurul Huda	1330	L	0107745569	Mojokerto	2010-05-31	3516033105100002	Islam	Tirto Wening	2	2	Karangsari	Bendunganjati	Kec. Pacet	61374	Bersama orang tua	Jalan kaki		082334489101			Tidak		Mustaqim	1985	SMP / sederajat	Karyawan Swasta	Rp. 2,000,000 - Rp. 4,999,999	3516030308850002	Khoiliyah Dwi Nur Rosidah	1991	SMP / sederajat	Tidak bekerja	Tidak Berpenghasilan	3516034606910003			Tidak sekolah				Kelas IX A			Tidak		0		8582/DS.T/2010/KAB.MR`;

// Function to parse the raw TSV data
const parseStudents = (): Student[] => {
    ...
    return lines.map((line, index) => {
        ...
        const student: Student = {
            ...
            nis: safeCol(2),
            fullName: safeCol(1),
            gender: safeCol(3) === 'L' ? 'L' : 'P',
            nisn: safeCol(4),
            birthPlace: safeCol(5),
            birthDate: safeCol(6),
            religion: safeCol(8),
            nationality: 'WNI',
            address: safeCol(9),
            ...
            guardian: safeCol(36) ? {
                name: safeCol(36),
                nik: safeCol(41),
                birthPlaceDate: safeCol(37),
                education: safeCol(38),
                job: safeCol(39),
                income: safeCol(40),
                phone: ''
            } : undefined,
            previousSchool: safeCol(56),
            graduationYear: 2025,
            diplomaNumber: safeCol(44),
            averageScore: 0,
            achievements: [],
            dapodik: {
                nik: safeCol(7),
                ...
                rw: safeCol(11),
                dusun: safeCol(12),
                kelurahan: safeCol(13),
                kecamatan: safeCol(14),
                kodePos: safeCol(15),
                livingStatus: safeCol(16),
                transportation: safeCol(17),
                email: safeCol(20),
                skhun: safeCol(21),
                kpsReceiver: safeCol(22),
                kpsNumber: safeCol(23),
                kipReceiver: safeCol(45),
                kipNumber: safeCol(46),
                kipName: safeCol(47),
                kksNumber: safeCol(48),
                birthRegNumber: safeCol(49),
                bank: safeCol(50),
                bankAccount: safeCol(51),
                bankAccountName: safeCol(52),
                pipEligible: safeCol(53),
                pipReason: safeCol(54),
                specialNeeds: safeCol(55),
                latitude: safeCol(58),
                longitude: safeCol(59),
                headCircumference: parseInt(safeCol(63)) || 0,
                distanceToSchool: safeCol(65),
                unExamNumber: safeCol(43)
            },
            documents: [],
            correctionRequests: [],
            academicRecords: {
...
export const MOCK_STUDENTS: Student[] = parseStudents();
